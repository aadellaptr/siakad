<?php
  ...
  if(isset($_POST['edit'])){
    ...
    $query ="UPDATE user, siswa SET user.nama='$nama', user.jk='$jk', user.no_hp='$no_hp', siswa.id_paket='$id_paket', siswa.th_ujian='$th_ujian', siswa.nisn='$nisn',kewarganegaraan='$kewarganegaraan', siswa.nik='$nik', siswa.no_kk='$no_kk', siswa.tempat_lahir='$tempat_lahir', siswa.tgl_lahir='$tgl_lahir',
    ...
    if (mysqli_query($conn, $query)){
        ...
        echo "<script>window.location='data-diri.php?id=".$_SESSION['user']['id_user']."&message=Data Berhasil Disimpan';</script>";
        exit();
    }else{
        // die (mysqli_error($conn));
        echo "<script>window.location='data-diri.php?id=".$_SESSION['user']['id_user']."&message=Data Gagal Disimpan';</script>";
    } 
  }
