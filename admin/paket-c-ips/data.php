<?php
$page = "PKBM Sanggar Puri | Paket C (IPS)";
include "../header.php";
?>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Data Siswa Paket C (IPS)</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="../dashboard/index.php">Home</a></li>
                        <li class="breadcrumb-item active">Paket C (IPS)</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            if (isset($_GET['th_ujian'])){
                                                $thn = $_GET['th_ujian'];
                                                $query = mysqli_query($conn, "SELECT *  FROM user INNER JOIN siswa ON user.id_user=siswa.id_user WHERE id_paket='4' AND th_ujian='$thn' AND status='2' AND daftar_ulang='2'");
                                            }else{
                                                $query = mysqli_query($conn, "SELECT *  FROM user INNER JOIN siswa ON user.id_user=siswa.id_user WHERE id_paket='4' AND th_ujian='$now' AND status='2' AND daftar_ulang='2'");
                                            }
...
$(function () {
      $("#admin").DataTable({
        ...
        "buttons": [{extend :'excel', 
                     title : 'Data Siswa Paket C (IPS) <?php echo "(".$tgl.")"?>'
                    },"colvis"]
