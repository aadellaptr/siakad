      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="data.php">Paket C (IPS)</a></li>
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="row no-print">
              <div class="col-12">
                <a href="detail-print.php?id=<?=$data['id_user']?>" rel="noopener" target="_blank" class="btn btn-primary float-right"><i class="fas fa-print"></i> Print</a>
              </div>
            </div>
          </div>
          <!-- /.card-header -->
